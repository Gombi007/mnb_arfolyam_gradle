    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.greenfox.arfolyam.soap.MNBArfolyamServiceSoapImpl.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.greenfox.arfolyam.soap.MNBArfolyamServiceSoapImpl.class.getResource(".");
