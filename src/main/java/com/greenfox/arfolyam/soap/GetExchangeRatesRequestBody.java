...
package com.greenfox.arfolyam.soap;
...
public class GetExchangeRatesRequestBody {
    ...
    @XmlElementRef(name = "startDate", namespace = "http://www.mnb.hu/webservices/", type = JAXBElement.class)
    protected JAXBElement<String> startDate;
    @XmlElementRef(name = "endDate", namespace = "http://www.mnb.hu/webservices/", type = JAXBElement.class)
    protected JAXBElement<String> endDate;
    @XmlElementRef(name = "currencyNames", namespace = "http://www.mnb.hu/webservices/", type = JAXBElement.class)
